...
# Configuration
To provide needed configuration just need to set environment variables for needed blockchain [node](https://github.com/e183b796621afbf902067460/defi-providers-fabric/tree/master/providers/fabrics) in certain fabric.
